...
class DonationSentPage extends StatefulWidget {
  @override
  _DonationSentPageState createState() => _DonationSentPageState();
}

class _DonationSentPageState extends State<DonationSentPage> {
  @override
